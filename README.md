...
704 executor integrity failures. The accepted replacement fails closed unless
that count is exactly zero. Licensed raw evidence and trade-level outputs
remain outside Git; only reproducibility code, tests, and artifact-derived
