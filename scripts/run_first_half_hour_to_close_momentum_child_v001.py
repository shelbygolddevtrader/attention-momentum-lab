#!/usr/bin/env python3
"""Build, verify, or exercise First Half-Hour To Close Momentum Child V001."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=Path("config/first_half_hour_to_close_momentum_child_v001.json"),
    )
    parser.add_argument(
        "--library",
        type=Path,
    ...
    parser.add_argument(
        "--evidence-root",
        type=Path,
        default=Path("manifests/first_half_hour_to_close_momentum_child_v001"),
    )
