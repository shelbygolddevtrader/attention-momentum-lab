#!/usr/bin/env python3
"""Build, verify, or exploratorily exercise Volatility Expansion Child V001."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=Path("config/opening_range_failed_breakout_reversal_child_v001.json"),
    )
    parser.add_argument(
        "--library",
        type=Path,
    ...
    parser.add_argument(
        "--evidence-root",
        type=Path,
        default=Path("manifests/opening_range_failed_breakout_reversal_child_v001"),
    )
